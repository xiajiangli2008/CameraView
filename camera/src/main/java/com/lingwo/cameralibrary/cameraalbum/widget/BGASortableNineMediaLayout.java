 ...
 */
public class BGASortableNineMediaLayout extends RecyclerView implements BGAOnItemChildClickListener, BGAOnRVItemClickListener {
    ...
    public BGASortableNineMediaLayout(Context context) {
        this(context, null);
    }

    public BGASortableNineMediaLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BGASortableNineMediaLayout(Context context, @Nullable AttributeSet attrs, int defStyle) {
     ...
     * @param photos
     */
    public void addMoreData(ArrayList<BGAMediaModel> photos) {
        if (photos != null) {
     ...
     * @param photo
     */
    public void addLastItem(BGAMediaModel photo) {
        if (photo != null) {
    ...
    private class PhotoAdapter extends BGARecyclerViewAdapter<BGAMediaModel>{
        ...
        @Override
        public BGAMediaModel getItem(int position) {
        ...
        protected void fillData(BGAViewHolderHelper helper, int position, BGAMediaModel model) {
            ...
            if (isPlusItem(position)) {
                ...
                BGAImage.display(helper.getImageView(R.id.iv_item_nine_photo_photo), mPlaceholderDrawableResId, model.getThumbNail(), mImageSize);
    ...
    private class ItemTouchHelperCallback extends ItemTouchHelper.Callback {
        ...
        public boolean onMove(RecyclerView recyclerView, ViewHolder source, ViewHolder target) {
            ...
            if (mDelegate != null) {
                mDelegate.onNinePhotoItemExchanged(BGASortableNineMediaLayout.this, source.getAdapterPosition(), target.getAdapterPosition(), getData());
            }
            return true;
        }
    ...
    public interface Delegate{
        void onClickAddNinePhotoItem(BGASortableNineMediaLayout sortableNineMediaLayout, View view, int position, ArrayList<BGAMediaModel> models);

        void onClickDeleteNinePhotoItem(BGASortableNineMediaLayout sortableNineMediaLayout, View view, int position, BGAMediaModel model, ArrayList<BGAMediaModel> models);

        void onClickNinePhotoItem(BGASortableNineMediaLayout sortableNineMediaLayout, View view, int position, BGAMediaModel model, ArrayList<BGAMediaModel> models);

        void onNinePhotoItemExchanged(BGASortableNineMediaLayout sortableNineMediaLayout, int fromPosition, int toPosition, ArrayList<BGAMediaModel> models);
    }
}
